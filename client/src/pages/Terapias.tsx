...
import { terapiaServices } from "../data/services";

export default function Terapias() {
  // Função para criar link do WhatsApp
  const createWhatsAppLink = (service: string) => {
    const message = encodeURIComponent(`Olá! Gostaria de agendar uma sessão de ${service}.`);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">Terapias Energéticas</h1>
        <p className="text-lg text-gray-600">
          Tratamentos energéticos para equilibrar corpo, mente e espírito
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {Object.entries(terapiaServices).map(([key, service]) => (
